...
- [x] 2.2 Refactor `useReportsData` to load selector options from projects, load project-member table rows from backend report responses, ignore stale responses, keep setup controls export-only, and keep member/table filters local.
