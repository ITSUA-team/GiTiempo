...
- Frontend: future implementation work in `apps/user-web/src/views/DashboardView.vue` can focus on dashboard overview content instead of duplicate timer controls.
