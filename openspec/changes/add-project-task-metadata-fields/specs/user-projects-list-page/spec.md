...
The Projects list page MUST render and save Description, Priority, Status, and Assignee fields in both task create and task update dialogs.

#### Scenario: Create dialog renders task metadata fields
- **WHEN** the user opens the Projects task create dialog
- **THEN** the dialog renders Description, Priority, Status, and Assignee fields in addition to Project and Task title
- **AND** Status defaults to `Open`
- **AND** Priority defaults to `Medium`
- **AND** Assignee defaults to unassigned

#### Scenario: Create dialog saves task metadata fields
- **GIVEN** the user has opened the Projects task create dialog
- **WHEN** the user enters a description, chooses priority, status, and assignee, and submits valid input
...
- **THEN** the dialog pre-fills Description, Priority, Status, and Assignee from the task response
...
- **WHEN** the user changes description, priority, status, or assignee and submits valid input
...
- **WHEN** the dialog renders the Assignee field
- **THEN** the selectable assignees are limited to active members assigned to the selected task project
- **AND** the user can clear the assignee to leave the task unassigned
