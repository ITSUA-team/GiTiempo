...
- [x] 1.2 Open `GITiempo.pen` in the Pencil editor and inspect the affected popup frames for task create/update, time-entry create/edit, admin create-invoice, and top-bar timer task-picker parity.
...
- [x] 5.4 Complete a final design parity review against `GITiempo.pen` and `docs/ui/patterns.md`, and document any PrimeVue-only compromise explicitly.
