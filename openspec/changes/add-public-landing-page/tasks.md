...
- [x] 2.4 Add typed local content/configuration data for navigation, enabled role/scope cards, workflow steps, and static FAQs without introducing a client runtime.
...
- [x] 3.3 Implement `#how-it-works`, roles, and MVP scope sections while omitting the documentation-disabled Admin-role and Reports/Invoices cards.
...
- [x] 4.1 Add tests for environment validation, canonical/metadata generation, exact CTA labels and destinations, section ordering/anchors, one-`h1` structure, disabled-content omission, and zero hydrated islands.
