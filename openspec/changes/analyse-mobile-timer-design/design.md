...
Relevant source-of-truth files are `docs/ui/layout.md`, `docs/ui/pages-user.md`, `apps/user-web/AGENTS.md`, and shared header ownership in `packages/web-shared/AGENTS.md` if the shared header structure changes.
