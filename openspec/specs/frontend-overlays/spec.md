# Frontend Overlays Specification

## Purpose

Define cross-SPA ownership and presentation requirements for PrimeVue overlay service hosts so toast and confirmation feedback remains stable across public routes, authenticated shells, and feature pages.
...
The frontend SPAs SHALL use the documented shared top-right placement and `w-80` width target for root Toast hosts.
