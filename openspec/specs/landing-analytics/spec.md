# Landing Analytics Specification

## Purpose

Define optional, consent-controlled GA4 measurement for the public landing application, including its configuration, privacy boundary, approved events, verification, and operational rollback.
