...
Define workspace invite creation, delivery, acceptance, and retry behavior so admins can safely onboard members while preserving membership and invite-token integrity.
