...
Define the admin-web Dashboard page behavior for API-backed workspace overview metrics, recent activity, and async states inside the authenticated admin shell.
