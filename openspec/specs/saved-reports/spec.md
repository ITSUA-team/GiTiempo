...
Define workspace-scoped named report presets — the absolute date range, grouping path, identity scope, and column filters they capture, and the admin/PM access that governs them.
