...
- **THEN** the system responds with 200 and body containing `{ id, workspaceId, currency, defaultHourlyRate, createdAt, updatedAt }`
...
The system SHALL allow admins to update currency and/or defaultHourlyRate.
