...
| `INVITES_EMAIL_CONSOLE_FALLBACK_SHOW_SECRETS` | Local dev only | Optional debug flag for full invite/setup URLs in console fallback; do not enable in shared or production environments |
