...
- A preset captures the absolute date range, the ordered grouping path, the project and member scope, and every column filter. Opening one restores all of it and reloads the report.
