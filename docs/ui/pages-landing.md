...
- State service purposes, recipients, retention, security limitations, rights/contact-based deletion requests, and policy revisions. Limited Use covers all extension user data, including GitHub-derived data. Organizational transfer/human-access restrictions and actual processors, regions, retention and backups were confirmed from production infrastructure on 2026-09-16 and are recorded in `docs/chrome-web-store-privacy.md`; the public policy contains only confirmed, publishable facts.
