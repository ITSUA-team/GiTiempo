...
const popupGoogleButtonClass = `${popupOAuthButtonBaseClass} border-divider enabled:hover:bg-app-bg bg-surface-primary text-text-dark border`;
const popupGithubButtonClass = `${popupOAuthButtonBaseClass} bg-github enabled:hover:bg-github-hover text-text-inverse`;
