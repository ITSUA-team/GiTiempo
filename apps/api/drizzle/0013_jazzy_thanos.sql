...
ALTER TABLE "refresh_tokens" ADD COLUMN "workspace_id" uuid NOT NULL;--> statement-breakpoint
...
CREATE INDEX "refresh_tokens_workspace_member_id_idx" ON "refresh_tokens" USING btree ("workspace_member_id");--> statement-breakpoint
