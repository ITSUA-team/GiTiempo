    ...
    <div class="flex flex-col gap-4">
      <section class="flex flex-col gap-1.5">
        ...
        <p class="text-text-muted text-sm leading-5">
          Choose which GitHub organizations this workspace can use. Members
          still only see data their connected GitHub account can access.
        </p>
      </section>
      ...
      <section class="flex flex-col gap-3">
        ...
        <div
          ...
          class="border-divider bg-surface-secondary flex flex-col gap-3 rounded-lg border p-4"
        >
          <div class="flex flex-col gap-1">
          ...
          >
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                ...
                class="bg-accent-tint text-brand hover:bg-accent-tint/80 focus-visible:outline-brand inline-flex h-[38px] shrink-0 items-center justify-center rounded-sm px-3 text-sm font-semibold transition-colors focus-visible:outline-2 focus-visible:outline-offset-2"
              >
                {{ step.action.label }}
              </a>
            </div>
