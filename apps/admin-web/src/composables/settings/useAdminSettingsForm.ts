...
interface UseAdminSettingsFormOptions {
...
export function useAdminSettingsForm(options: UseAdminSettingsFormOptions) {
  ...
  const canSave = computed(
    () => isDirty.value && !toValue(options.saving) && !toValue(options.loading),
  );
