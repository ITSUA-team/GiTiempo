  ...
  <div class="bg-app-bg flex min-h-full flex-col gap-6 p-6">
    ...
    <template v-else>
      ...
      >
        <Button
          label="New Project"
          class="bg-brand text-surface rounded-[6px] px-4 py-[10px] text-sm font-semibold"
      ...
      <!-- Projects card -->
      <div
        class="shadow-card bg-surface flex flex-col gap-4 rounded-[10px] p-5"
      >
        <!-- Table header row -->
    ...
    >
      <div class="flex flex-col gap-4 pt-2">
        ...
        <div class="flex flex-col gap-1">
          <label class="text-text-dark text-[13px] font-medium">Project name</label>
          <InputText
        ...
        <!-- Visibility field -->
        <div class="flex flex-col gap-1">
          <label class="text-text-dark text-[13px] font-medium">Visibility</label>
          <Select
