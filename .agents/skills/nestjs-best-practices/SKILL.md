...
description: NestJS best practices and architecture patterns for building production-ready applications. Use when writing, reviewing, or refactoring NestJS code to ensure proper patterns for modules, dependency injection, security, and performance.
license: MIT
metadata:
  author: Kadajett
  version: "2.0.0"
...
- Building event-driven monoliths or microservices
...
| 7 | Database & Query Builder | MEDIUM-HIGH | `db-` |
| 8 | API Design | MEDIUM | `api-` |
| 9 | Microservices & Events | MEDIUM | `micro-` |
...
- `arch-encapsulate-db-queries` - Encapsulate database queries in services or query services
...
### 7. Database & Query Builder (MEDIUM-HIGH)

- `db-avoid-n-plus-one` - Avoid N+1 query problems
- `db-use-migrations` - Use Drizzle Kit migrations for schema changes
...
### 9. Microservices & Events (MEDIUM)

- `micro-use-patterns` - Message and event patterns (includes event-driven monolith guidance)
- `micro-use-health-checks` - Health checks for orchestration
- `micro-use-queues` - Background job processing with BullMQ
