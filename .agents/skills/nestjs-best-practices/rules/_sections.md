...
## 7. Database & Query Builder (db)

**Impact:** MEDIUM-HIGH
**Description:** Proper database access patterns with Drizzle ORM, migrations, and query optimization are crucial for data-intensive applications.
